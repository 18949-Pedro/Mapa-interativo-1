...
const transportMarkers = [
    {x: 2030, y: 629, name: "Transporte - Dirtmouth"},
    {x: 1220, y: 310, name: "Transporte - Penhascos Uivantes (Ninho dos Besouros)"},
    {x: 2329, y: 906, name: "Transporte - Encruzilhada Esquecida"},
    {x: 891, y: 775, name: "Transporte - Caminho Verde"},
    {x: 1460, y: 1460, name: "Transporte - Ermos  (Estação da Rainha) "},
    {x: 2471, y: 1263, name: "Transporte - Cidade das Lágrimas (Armazéns da Cidade)"},
    {x: 3491, y: 1725, name: "Transporte - Cidade das Lágrimas (Estação do Rei)"},
    {x: 465, y: 1807, name: "Transporte - Ninho Profundo (Aldeia Distante)"},
    {x: 830, y: 1367, name: "Transporte - Jardins da Rainha"},
    {x: 3548, y: 863, name: "Transporte - Terra do Descanso"},
    {x: 3221, y: 2236, name: "Transporte - Campos do Palácio (Estação Escondida)"}
];
...
const soulMarkers = [
    {x: 2030, y: 629, name: "Fragmento de Receptaculo "},
    {x: 1987, y: 629, name: "Fragmento de Receptaculo "},
    {x: 2088, y: 984, name: "Fragmento de Receptaculo "},
    {x: 1010, y: 1060, name: "Fragmento de Receptaculo "},
    {x: 1847, y: 1973, name: "Fragmento de Receptaculo "},
    {x: 2794, y: 2131, name: "Fragmento de Receptaculo "},
    {x: 2683, y: 1395, name: "Fragmento de Receptaculo "},
    {x: 1407, y: 390, name: "Fragmento de Receptaculo "},
    {x: 3419, y: 813, name: "Fragmento de Receptaculo "}
];
